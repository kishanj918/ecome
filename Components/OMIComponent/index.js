                ...
                <View style={[styles.headerContainer]}>
                    <View style={[styles.imagesContainer]}>
                        <TouchableOpacity onPress={() => {
                            ...
                            <Image source={require('../../assets/images/redBack.png')} style={{ height : 45.5, width : 23 }} resizeMode={'contain'} />
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Image source={require('../../assets/images/redSquare.png')} style={{ marginLeft : 8.5, height : 45.5, width : 45.5 }} resizeMode={'contain'} />
                        </TouchableOpacity>
